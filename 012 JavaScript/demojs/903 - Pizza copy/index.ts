        ...
        function cadastrar() {
            var pizza: [string, number, number]
            ...
            (document.getElementById("idPreco") as HTMLInputElement).value = ""; 
            (document.getElementById("idNome") as HTMLInputElement).value = "";  
        ...
        function calcularPrecoCm2(preco:number, tamanho:number) : number{
        ...
        function exibirRel() {
            ...
            pizzas.sort(function (a, b):number {
                if (a[3] > b[3]) {
                    return 1
                }
                if (b[3] > a[3]) {
